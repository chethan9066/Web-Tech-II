...
if(empty($f_name) || empty($l_name) || empty($age) || empty($email) || empty($password) || empty($repassword) ||
	empty($mobile) || empty($address1) || empty($address2)){
		...
		echo "
			<div class='alert alert-warning'>
				...
				<b>This value $f_name is not valid.</b>
			</div>
		";
		exit();
	}
	if(!preg_match($name,$l_name)){
		echo "
			<div class='alert alert-warning'>
				<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
				<b>This value $l_name is not valid.</b>
			</div>
		";
		exit();
	}
	...
	if(!(strlen($mobile) == 10)){
		echo "
			<div class='alert alert-warning'>
				<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
				<b>Mobile number must have 10 digits.</b>
			</div>
		";
		exit();
	}
