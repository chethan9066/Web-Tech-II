...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["keyword"])){
		...
		if($count > 0){
			echo "
				<div class='alert alert-warning'>
						...
						<b>Product already added to Cart. Go to cart to change quantity.</b>
				</div>
			";
		} else {
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@pesecommerce.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/webproject/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/webproject/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/webproject/cancel.php"/>
